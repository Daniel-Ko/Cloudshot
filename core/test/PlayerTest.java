...
public class PlayerTest extends GameTest{
    ...
    public void TestBulletsFiredIncreased(){
        ...
        /*Player  p = gameModel.getPlayer();
          assert p.getBullets().size == 0 : "Player has not shot therefore bulletsBeenShot should be empty";
        * p.shoot()
        * assert p.getBullets().size == 1;
        *
        * */
    }
    ...
    public void TestPlayerDeath(){
        ...
        *int initHP = p.getHealth();
        *p.hit(initHP);
        * assert p.getPlayerState() == AbstractPlayer.state.DEAD;
        * */
    }
